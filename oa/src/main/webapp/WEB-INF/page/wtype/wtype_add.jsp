...
<form class="layui-form" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block" style="width: 300px;">
      <input type="text" id="coding" name="coding" required lay-verify="required" placeholder="请输入物品编号" autocomplete="off" class="layui-input">    
    </div>
  </div>
  <div class="layui-form-item">
...
$(function(){
	$("#subBtn").click(function(){
		 ...
		 var note=$("#note").val();
		 $.ax({
			url:'${ctx}/admin/wtype/saveWtypeConfig',
			data:{'coding':coding,'name':name,'note':note},
