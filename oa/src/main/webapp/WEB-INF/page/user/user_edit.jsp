...
<script>
	...
	;!function() {
		...
		form.on('submit(go)', function(data) {
			...
			$.ax({
				url : '${ctx}/admin/user/modifyUserById',
				data : data.field,
	...
	$(function() {
		$.ax({
			...
			success : function(res) {
				...
				var orgNode = zTreeObj.getNodeByParam('id', '${data.orgId}',
						null);
				if (orgNode == null) {
					return;
				}
				$('#orgName').val(orgNode.orgName);
			}
		});
		//formTest 即 class="layui-form" 所在元素对应的 lay-filter="" 对应的值
		form.val('example', {
			"id" : '${data.id }',
			"userCode" : '${data.userCode}', // "name": "value"
