...
<script type="text/javascript">
  ...
  table.render({
	    ...
	    ,even: true
   	    ,height: 'full-20'
	    ,url:'${ctx}/admin/cwarehouse/getCwarehouseConfigPage'
   	    ,request: {
	    ...
	    ,cols: [[
	      ...
	      ,{field: 'name', title: '仓库名称', width: 250,align:'center',sort: true}
	      ,{field: 'capacity', title: '仓库剩余容量', width: 250,align:'center',sort: true}
	      ,{field: 'administratorName', title: '仓库管理员', width: 250,align:'center',sort: true}
	      ,{field: 'administratorPhone', title: '管理员联系方式', width: 250,align:'center',sort: true}
	  ...
	  switch(obj.event){
	  		case 'add':
	  			layer.open({
	  			  ...
	  			  shade: 0.8,
	  			  area: ['500', '400'],
	  			  content: '${ctx}/admin/cwarehouse/toCwarehouseInfoAddPage'
	  			}); 
 		   	break;
	  		case 'update':
	  			...
	  			layer.open({
	  				  ...
	  				  shade: 0.8,
	  				  area: ['500', '400'],
	  				  content: '${ctx}/admin/cwarehouse/toCwarehouseInfoEditPage?id='+id
	  				}); 
	 		break;
	  		case 'del':
	  			var checkStatus = table.checkStatus('tableList');
	  			...
	  			layer.confirm('确定删除该数据吗？', {
	  				  btn: ['确定','取消']
	  					 ...
	  					 $.ax({
	  						url:'${ctx}/admin/cwarehouse/delCwarehouseInfoByIds',
	  						data:{'ids':ids.join(',')},
